...
opciones=(
    "Montar disco hda2:|sudo mount /dev/hda2 /mnt/hda2"
    "Desmontar disco hda2:|sudo umount /mnt/hda2"
    "Forzar desmontaje de disco hda2:|sudo fuser -km /mnt/hda2"
    "Desmontar disco hda2 sin leer el archivo mtab:|sudo umount -n /mnt/hda2"
    "Montar floppy:|sudo mount /dev/fd0 /mnt/floppy"
    "Montar CDROM/DVDROM:|sudo mount /dev/cdrom /mnt/cdrom"
    "Montar CD regrabable o DVDROM:|sudo mount /dev/hdc /mnt/cdrecorder"
    "Montar CD regrabable o DVDROM (un DVD):|sudo mount /dev/hdb /mnt/cdrecorder"
    "Montar imagen de medio óptico:|sudo mount -t udf,iso9660 -o loop file.iso /mnt/cdrom"
    "Montar sistema de archivos FAT32:|sudo mount -t vfat /dev/hda5 /mnt/hda5"
    "Montar sistema de archivos NTFS:|sudo mount -t ntfs-3g /dev/hda5 /mnt/hda5"
    "Montar USB o memoria (sin especificar el tipo de sistema de archivos):|sudo mount /dev/sda1 /mnt/usbdisk"
    "Salir:|exit 0"
)
