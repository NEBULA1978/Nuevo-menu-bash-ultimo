...
opciones=(
    ...
    "Crear nuevo grupo:|sudo groupadd nombre_del_grupo"
    "Borrar grupo existente:|sudo groupdel nombre_del_grupo"

    "Renombrar grupo existente:|sudo groupmod -n nuevo_nombre_del_grupo viejo_nombre_del_grupo"

    "Crear nuevo usuario con asistente:|sudo adduser usuario1"

    "Crear nuevo usuario en grupo 'admin':|sudo useradd -c 'Nombre Apellido' -g admin -d /home/usuario1 -s /bin/bash usuario1"

    "Crear nuevo usuario:|sudo useradd usuario1"

    "Borrar usuario y su directorio Home:|sudo userdel -r usuario1"

    "Cambiar atributos de usuario:|sudo usermod -c 'Usuario de ' -g system -d /ftp/usuario1 -s /sbin/nologin usuario1"

    "Agregar usuario a otros grupos existentes:|sudo usermod -aG plugdev,dialout,pip user1"

    "Cambiar contraseña actual:|passwd"

    "Cambiar contraseña de un usuario:|sudo passwd usuario1"

    "Colocar plazo para la contraseña de un usuario:|sudo chage -E 2011-12-31 user1"

    "Chequear sintaxis y existencia de usuarios:|sudo pwck"

    "Chequear sintaxis y existencia de grupos:|sudo grpck"

    "Registrar nuevo grupo predeterminado para ficheros creados recientemente:|newgrp grupo1"
